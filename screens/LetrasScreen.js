...
export default function LetrasScreen({ navigation }) {
  ...
  const siguiente = () => {
    if (indice < preguntas.length - 1) {
      ...
      navigation.replace("Felicidades", { tipoJuego: "Letras", huboFallos: huboError });
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.pregunta}>¿Con qué letra empieza?</Text>
      ...
      <View style={styles.opcionesContainer}>
        {pregunta.opciones.map((opcion, index) => (
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            <View style={[styles.contenedorFondoColor, { backgroundColor: "#4FC3F7" }]}>
              <ImageBackground
                source={botonLPixel}
                resizeMode="stretch"
